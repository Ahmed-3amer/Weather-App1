...
async function getWeatherData(cityName){
    let weatherResponse = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=6254596e39064a108d3211453242001&q=${cityName}&days=3&aqi=no&alerts=no`);
...
function displayTodayData(data){
    ...
    document.querySelector('.weather-table').style.backgroundImage = `url("https://source.unsplash.com/1600x900/?${data.location.name}")`;
}
